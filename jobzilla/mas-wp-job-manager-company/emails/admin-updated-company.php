...
?>
	<p><?php
		echo wp_kses_post(
			...
			sprintf( __( 'A company has been updated on <a href="%s">%s</a>.', 'jobzilla' ), home_url(), esc_html( get_bloginfo( 'name' ) ) ) );
		switch ( $company->post_status ) {
			...
			case 'pending':
				echo wp_kses_post( sprintf(
					...
					' ' . __( 'The company is not publicly available until the changes are approved by an administrator in the site\'s <a href="%s">WordPress admin</a>.', 'jobzilla' ),
