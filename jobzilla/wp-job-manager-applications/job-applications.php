...
<div id="job-manager-job-applications">
	<a href="<?php echo esc_url( add_query_arg( 'download-csv', true ) ); ?>" class="job-applications-download-csv"><?php _e( 'Download CSV', 'jobzilla' ); ?></a>
	<p><?php printf( __( 'The job applications for "%s" are listed below.', 'jobzilla' ), '<a href="' . get_permalink( $job_id ) . '">' . get_the_title( $job_id ) . '</a>' ); ?></p>
	<div class="job-applications">
		<form class="filter-job-applications" method="GET">
			<p>
				<select name="application_status">
					<option value=""><?php _e( 'Filter by status', 'jobzilla' ); ?>...</option>
			...
			<p>
				<select name="application_orderby">
					<option value=""><?php _e( 'Newest first', 'jobzilla' ); ?></option>
					<option value="name" <?php selected( $application_orderby, 'name' ); ?>><?php _e( 'Sort by name', 'jobzilla' ); ?></option>
					<option value="rating" <?php selected( $application_orderby, 'rating' ); ?>><?php _e( 'Sort by rating', 'jobzilla' ); ?></option>
				</select>
