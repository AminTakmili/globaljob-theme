...
<form class="job-manager-application-edit-form job-manager-form" method="post">
	...
	<fieldset class="fieldset-status">
		<label for="application-status-<?php echo esc_attr( $application->ID ); ?>"><?php _e( 'Application status', 'jobzilla' ); ?>:</label>
		<div class="field">
	...
	<fieldset class="fieldset-rating">
		<label for="application-rating-<?php absint( $application->ID ); ?>"><?php _e( 'Rating (out of 5)', 'jobzilla' ); ?>:</label>
		<div class="field">
	...
	<p>
		<a class="delete_job_application" href="<?php echo wp_nonce_url( add_query_arg( 'delete_job_application', $application->ID ), 'delete_job_application' ); ?>"><?php _e( 'Delete', 'jobzilla' ); ?></a>
		<input type="submit" name="wp_job_manager_edit_application" value="<?php esc_attr_e( 'Save changes', 'jobzilla' ); ?>" />
