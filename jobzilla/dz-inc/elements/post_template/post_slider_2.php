<?php 
	...
	$post_type_gallery2	= jobzilla_dzbase()->get_meta('post_type_gallery2');
			...
			<div class="<?php echo esc_attr($classes); ?>">
				<?php while( have_posts() ){ the_post();  ?>
					...
					<div class="<?php echo esc_attr($blog_classes); ?>">
						<?php if(!empty($post_type_gallery2)) {  $post_type_gallery2 = explode(',',$post_type_gallery2); ?>
						<div class="dz-media">
							<div class="swiper-container post-swiper-2">
								<div class="swiper-wrapper">
									<?php foreach($post_type_gallery2 as $image_id) { ?>
										<div class="swiper-slide">
											<?php echo wp_get_attachment_image($image_id,'large'); ?>
										</div>
									<?php } ?>
								</div>
								<div class="btn-prev swiper-button-prev"><i class="las la-arrow-left"></i></div>
								<div class="btn-next swiper-button-next"><i class="las la-arrow-right"></i></div>
							</div>
							
							<div class="swiper-container post-swiper-two">
								<div class="swiper-wrapper">
									<?php foreach($post_type_gallery2 as $image_id) { ?>
										<div class="swiper-slide">
