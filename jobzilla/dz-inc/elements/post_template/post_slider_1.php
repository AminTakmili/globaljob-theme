...
<?php if(!empty($post_type_gallery1)) {  $post_type_gallery1 = explode(',',$post_type_gallery1); ?>
	<div class="container content-inner pb-4">
		<div class="row">
			<div class="col-lg-12">
				<div class="dz-media">
						...
						<div class="swiper-wrapper">
							<?php foreach($post_type_gallery1 as $image_id) { ?>
								<div class="swiper-slide">
									<img class="rounded-sm" src="<?php echo esc_url(wp_get_attachment_image_url($image_id,'large')); ?>" alt="<?php echo esc_attr__('Image','jobzilla'); ?>">
								</div>
							<?php } ?>
						</div>
...
<div class="<?php echo esc_attr(jobzilla_get_container($is_sidebar)); ?> content-inner pt-4">
	<div class="row">
