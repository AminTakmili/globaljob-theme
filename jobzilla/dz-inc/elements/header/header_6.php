<?php
	...
	$header_theme = jobzilla_dzbase()->get_meta('page_header_theme'); 
	$class = ($header_theme == 'dark') ? 'sidebar-text-dark':'';
?>
<!-- Header -->
	<header class="site-header header-transparent mo-left header style-2 header-sidebar  dz-mega-menu-fullwidth <?php echo esc_attr($class) ?>" data-sidebar="header-sidebar">		
		<!-- Main Header -->
			...
			<div class="main-bar clearfix">
				<div class="container-fluid clearfix">
					...
					<div class="logo-header logo-dark">
						...
						do_action( 'jobzilla_get_logo','site_other_logo'); ?>
					</div>
					...
					<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
						...
						<?php
						if(jobzilla_check_plugin_active('dz-mega-menu/dz-mega-menu.php') && class_exists('Dz_Mobile_Menu')){
						?>
