<div class="loadmore-content" id="masonry">				
	<?php 	
		...
		/* Post Sorting */
		$sorting_on = jobzilla_get_opt('category_page_sorting_on');
	  
		$orderby = $order = '';
	  
		if($sorting_on)
		{
			$sorting	= jobzilla_get_opt('category_page_sorting');
...
<?php if( 1 < $max_num_pages ) { ?>
	...
	<div class="reload-btn text-center mb-4">
		<a href="javascript:void(0);" class="btn loadmore-btn site-button dz-load-more btn-primary common-page-dz-load-more"  
