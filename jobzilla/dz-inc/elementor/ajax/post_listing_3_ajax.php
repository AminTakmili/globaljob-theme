<?php
	...
	if($show_column == 'col_2'){
		$col_classes = 'col-lg-6 col-md-12 m-b30 wow fadeInUp';
	}elseif($show_column == 'col_3'){
		$col_classes = 'col-lg-4 col-md-12 m-b30 wow fadeInUp';
	}else{
		$col_classes = 'col-lg-3 col-md-12 m-b30 wow fadeInUp';
	}
	...
	<div id="post-<?php the_ID(); ?>" <?php echo post_class($col_classes.' masonry-item'); ?> >		
		<div class="blog-post twm-blog-post-3-outer <?php echo esc_attr($post_layout); ?>" data-wow-delay=".2s" data-wow-duration="2s">			
			<?php
