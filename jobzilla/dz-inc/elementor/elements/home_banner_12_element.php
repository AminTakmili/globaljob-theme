<?php
	...
	$category_arr = array();
	if($home_banner_12_element_search_job_category=='yes'){ 
	...
	if($home_banner_12_element_job_tags=='yes'){ 
...
?>
   ...
   <!--Banner Start-->
            <div class="twm-home3-banner-section site-bg-primary twm-bnr-hpage-12">
                <div class="container">
                    <div class="twm-home3-inner-section">
                        <div class="twm-bnr-mid-section">

						<?php if (!empty($home_banner_12_element_title)) { ?>
							<div class="twm-bnr-title-large">
								<?php echo wp_kses($home_banner_12_element_title,'string'); ?>
							</div>
						<?php } 
						if (!empty($home_banner_12_element_subtitle)) { ?>
							<div class="twm-bnr-title-light">
								<?php echo wp_kses($home_banner_12_element_subtitle,'string'); ?>
							</div>
						<?php } 
						if (!empty($home_banner_12_element_description)) { ?>
							<div class="twm-bnr-discription">
								<?php echo wp_kses($home_banner_12_element_description,'string'); ?>
							</div>
						<?php } ?>
                             <div class="twm-bnr-search-bar">
								<form method="get" id="KeywordsForm" action="<?php echo home_url(jobzilla_get_opt('jobzilla_job_filter_page')); ?>">
									<div class="row">
										<?php if($home_banner_12_element_search_job_title == 'yes'){ ?>
											<!--Title-->
										...
										<?php if($home_banner_12_element_search_job_category =='yes'){ ?>
											<!--All Category-->
											<div class="form-group col-xl-3 col-lg-6 col-md-3">
												<label>
										...
										if(get_option( 'job_manager_regions_filter')){
										 ...
										 if($home_banner_12_element_search_job_location=='yes'){ ?>
											<!--Location-->
											<div class="form-group col-xl-3 col-lg-6 col-md-3">
										...
										if(!empty($home_banner_12_element_search_btn)){ ?>
											<!--Find job btn-->
											<div class="form-group col-xl-3 col-lg-6 col-md-3">
												<button type="submit" class="site-button">
													<?php echo esc_html($home_banner_12_element_search_btn); ?>
												</button>
											</div>
										<?php } ?>
									</div>
                        ...
                        <?php 
							if($home_banner_12_element_job_tags=='yes' && (!empty($job_listing_tag) && taxonomy_exists( 'job_listing_tag' ))){ ?>
							<div class="twm-bnr-popular-search">
								<?php if(!empty($home_banner_12_element_job_tags_title)){ ?>
									<span class="twm-title">
										<?php echo wp_kses($home_banner_12_element_job_tags_title,'string'); ?>
									</span>
								<?php } ?>
					...
					<?php if(!empty($home_banner_12_element_bottom_images['id'])){ ?>
                    <div class="twm-hpage12-bnr-pic">
                        <img src="<?php echo esc_url($home_banner_12_element_bottom_images['url']); ?>" alt="<?php echo esc_attr__('Image', 'jobzilla'); ?>">
                    </div>
					<?php } 
					 if(!empty($home_banner_12_element_images['id'])){ 
					?>
                    <div class="twm-hpage12-bnr-pic2">
                        <img src="<?php echo esc_url($home_banner_12_element_images['url']); ?>" alt="<?php echo esc_attr__('Image', 'jobzilla'); ?>">
                    </div>
					<?php } ?>
                </div>
				<?php if(!empty($home_banner_12_element_placeholder_text)){ ?>
                <h3 class="twm-banner-h12-r-outline-text">
                   <?php echo esc_html($home_banner_12_element_placeholder_text); ?>
                </h3>
				<?php } ?>
