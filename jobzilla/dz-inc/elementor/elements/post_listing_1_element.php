<?php
  ...
  //post_listing_1
    if($post_listing_1_element_selected_sidebar == 'No_Sidebar' || !is_active_sidebar( $post_listing_1_element_selected_sidebar ) || !jobzilla_is_theme_sidebar_active())
    {
    ...
    $jobzilla_query_result['posts_per_page'] = $post_listing_1_element_no_of_posts;   
    $jobzilla_query_result['current_page'] = $page_no;
    $jobzilla_query_result['side_bar'] = $post_listing_1_element_selected_sidebar;
    $jobzilla_query_result['title_text_limit'] = $post_listing_1_element_text_limit;    
    $jobzilla_query_result['show_column'] = $post_listing_1_element_cols;
...
<!-- Blog -->
    <div class="section-full content-inner-1">
        <div class="container">
            <?php if(!empty($post_listing_1_element_title) || !empty($post_listing_1_element_subtitle )){ ?>
                <div class="section-head center wt-small-separator-outer">
                    <?php if(!empty($post_listing_1_element_subtitle )){ ?>
                        <div class="wt-small-separator site-text-primary">
                           <div>
                                <?php echo wp_kses($post_listing_1_element_subtitle, 'string'); ?>
                           </div>                                
                        </div>
                    <?php } ?>
                    ...
                    <?php if(!empty($post_listing_1_element_title)){ ?>
                        <h2 class="wt-title">
                            <?php echo wp_kses($post_listing_1_element_title, 'string'); ?>
                        </h2>                
                    <?php } ?>
                </div>    
            <?php } ?>
            ...
            <div class="section-content">
                <div class="twm-blog-post-1-outer-wrap">
                    <div class="row d-flex justify-content-center">
                        <?php 
                            if ($post_listing_1_element_sidebar_layout == 'left' && 
                            is_active_sidebar( $post_listing_1_element_selected_sidebar ) && 
                      ...
                      <!-- Left part start -->
                            ...
                            <?php
                                ...
                                {   
                                    ...
                                    <a href="javascript:void(0);" class="btn wow fadeInUp  site-button loadmore-btn dz-load-more " id="<?php echo esc_attr($blog_view_btn); ?>"   
                                        ...
                                        data-posts-per-page="<?php echo esc_js($post_listing_1_element_no_of_posts);?>"
                                        data-image-preference="<?php echo esc_js($post_listing_1_element_image_preference); ?>"
                                        data-only-featured-post="<?php echo esc_js($post_listing_1_element_only_featured_posts)?>" 
                                        data-post-order="<?php echo esc_js($post_listing_1_element_order)?>"    
                                        data-post-order-by="<?php echo esc_js($post_listing_1_element_orderby)?>"   
                                        data-posts-in-categories="<?php echo esc_js($post_listing_1_element_posts_in_categories);?>"
                                        data-side-bar="<?php echo esc_js($post_listing_1_element_selected_sidebar);?>"
                                        data-show-column="<?php echo esc_js($post_listing_1_element_cols);?>"
                                        data-title-text-limit="<?php echo esc_js($post_listing_1_element_text_limit);?>" 
                                        >
                        ...
                        <?php 
                            if ($post_listing_1_element_sidebar_layout == 'right' && 
                                is_active_sidebar( $post_listing_1_element_selected_sidebar ) && 
                                jobzilla_is_theme_sidebar_active() ){ 
                        ?>
                            <div class="col-lg-4 col-md-12 rightSidebar">
