<?php
    ...
    if(!empty($post_listing_3_element_posts_in_categories) && !empty($post_listing_3_element_posts_in_categories[0])) {
        ...
        $post_listing_3_element_posts_in_categories = '';
    }
    
    if($post_listing_3_element_only_featured_posts == 'true') 
    {       
    ...
    if($post_listing_3_element_selected_sidebar == 'No_Sidebar' || !is_active_sidebar( $post_listing_3_element_selected_sidebar ) || !jobzilla_is_theme_sidebar_active())
    {
    ...
    $jobzilla_query_result['posts_per_page'] = $post_listing_3_element_no_of_posts;   
    $jobzilla_query_result['current_page'] = $page_no;
    $jobzilla_query_result['side_bar'] = $post_listing_3_element_selected_sidebar;
    $jobzilla_query_result['title_text_limit'] = $post_listing_3_element_text_limit;    
    $jobzilla_query_result['show_column'] = $post_listing_3_element_cols;
    $color = ($post_listing_3_element_color == 'style_2') ? ' site-bg-light-purple' : '';
...
?>
<!-- Blog -->
    <div class="section-full content-inner <?php echo esc_attr($color); ?>">
        <div class="container">
            <?php if(!empty($post_listing_3_element_title) || !empty($post_listing_3_element_subtitle )){ ?>
                            ...
                            <?php
                                ...
                                {   
                                    ...
                                    <a href="javascript:void(0);" class="btn wow fadeInUp  site-button loadmore-btn dz-load-more " id="<?php echo esc_attr($blog_view_btn); ?>"   
                                        ...
                                        data-show-column="<?php echo esc_js($post_listing_3_element_cols);?>"
