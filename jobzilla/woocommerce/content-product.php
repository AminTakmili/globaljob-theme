...
$product_column = jobzilla_get_opt('no_of_product_column');


if(is_product_category()){
	
	$show_sidebar	= jobzilla_get_opt('woocommerce_page_show_sidebar');
	$layout			= jobzilla_get_opt('woocommerce_page_sidebar_layout');
	$sidebar		= jobzilla_get_opt('woocommerce_page_sidebar');

	
}else{

	$show_sidebar	= jobzilla_dzbase()->get_meta('page_show_sidebar', get_option( 'woocommerce_shop_page_id' ));
	$layout			= jobzilla_dzbase()->get_meta('page_sidebar_layout', get_option( 'woocommerce_shop_page_id' ));
	$sidebar		= jobzilla_dzbase()->get_meta('page_sidebar', get_option( 'woocommerce_shop_page_id' ));
}
...
if($layout != 'full' && $product_column > 2){
	$product_column = 2;
}
if($product_column == 2)
{
            ...
            <div class="item-box">
              <div class="item-img">
                ...
                <div class="item-info-in">
                  <ul>
					<?php if(jobzilla_is_woo_catalog_shop_enable()){ 	?>
						<li>
							<?php
